...
<head>
    ...
    <link href="<?= Yii::getAlias('@web')?>/css/clean-blog.min.css" rel='stylesheet' type='text/css'/>
...
<header class="intro-header" style="background-image: url(<?= Yii::getAlias('@web')?>/images/<?=$this->params['image']; ?>)">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="page-heading">
                    <h1><?= $this->title ?></h1>
                    <hr class="small">
                    <span class="subheading"><?= $this->params['subtitle'] ?></span>
                </div>
            </div>
        </div>
    </div>
